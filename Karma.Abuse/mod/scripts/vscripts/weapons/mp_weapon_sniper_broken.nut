...
global function OnWeaponActivate_weapon_sniper_broken
global function OnWeaponPrimaryAttack_weapon_sniper_broken
global function OnProjectileCollision_weapon_sniper_broken

#if CLIENT
global function OnClientAnimEvent_weapon_sniper_broken
#endif // #if CLIENT

#if SERVER
global function OnWeaponNpcPrimaryAttack_weapon_sniper_broken
#endif // #if SERVER

void function OnWeaponActivate_weapon_sniper_broken( entity weapon )
{
#if CLIENT
...
#if CLIENT
void function OnClientAnimEvent_weapon_sniper_broken( entity weapon, string name )
{
...
var function OnWeaponPrimaryAttack_weapon_sniper_broken( entity weapon, WeaponPrimaryAttackParams attackParams )
{
...
#if SERVER
var function OnWeaponNpcPrimaryAttack_weapon_sniper_broken( entity weapon, WeaponPrimaryAttackParams attackParams )
{
	weapon.EmitWeaponNpcSound( LOUD_WEAPON_AI_SOUND_RADIUS_MP, 0.2 )
...
void function OnProjectileCollision_weapon_sniper_broken( entity projectile, vector pos, vector normal, entity hitEnt, int hitbox, bool isCritical )
{
	#if SERVER
